...
public class SimpleRenderer {
    ...
    public void onSurfaceChanged(GL10 gl, int width, int heigth) {
        Log.d("AR","superficie modificada" + width + "x" + heigth);
        ...
        gl.glLoadIdentity();
        GLU.gluPerspective(gl, 45.0f, (float) width/(float) heigth, 0.1f,100.0f);
    ...
    public void draw(GL10 gl) {
        ...
        gl.glTexCoordPointer(3, GL10.GL_FLOAT, 0, texturaBuffer);
